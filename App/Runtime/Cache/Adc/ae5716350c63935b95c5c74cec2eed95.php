    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="javascript"><i class="fa fa-edit fa-fw"></i> 文章管理<span class="fa arrow"></span></a>
                ...
                <div class="col-lg-8">
                    <div class="panel panel-green">
                        ...
                        <div class="panel-body">
                            ...
                            <div role="form" class="col-lg-12">
                                <button type="submit" class="btn btn-outline btn-primary">提交</button>
                                <button type="reset" class="btn btn-outline btn-default">取消</button>
                            </div>
                        </div>
                        <!-- /.panel-body -->
                    </div>
