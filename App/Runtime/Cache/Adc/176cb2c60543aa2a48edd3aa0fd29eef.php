                    ...
                    <div role="form" class="col-lg-8">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="pid" name="pid">
                                ...
                                <?php if(is_array($sorts)): foreach($sorts as $key=>$sort): if($sort["pid"] == 0): ?><option value="<?php echo ($sort["sid"]); ?>"><?php echo ($sort["sortname"]); ?></option><?php endif; endforeach; endif; ?>
                            </select>
                        </div>
                    </div>
                    <div role="form" class="col-lg-8">
